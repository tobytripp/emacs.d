...
(defun color-theme-pastels ()
  ...
  (color-theme-install
   '(color-theme-pastels
     ...
     (fl-comment-face ((t (:foreground "SlateBlue"))))
     (fl-doc-string-face ((t (:foreground "SlateBlue"))))
     ...
     (font-lock-preprocessor-face ((t (:foreground "RoyalBlue"))))
     ...
     (reb-match-0 ((t (:background "dark slate blue"))))
     (reb-match-1 ((t (:background "dark blue"))))
     ...
     (speedbar-highlight-face ((t (:background "gray13" :foreground "wheat"))))
