...
** EXPERIMENTAL itail mode for log files
   - State "EXPERIMENTAL" from              [2017-12-16 Sat 10:26]

   #+BEGIN_SRC emacs-lisp
     (require-package 'itail)
     (autoload 'itail "itail" "Interactive tail mode")
   #+END_SRC
...
** EXPERIMENTAL Tramp and Docker
   - State "EXPERIMENTAL" from              [2017-12-22 Fri 09:40]
