...
** Daemon Start-up
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (file-truename "~/.emacs.d/bin/emacs-daemon")
   #+END_SRC
...
*** TODO Launchd Service [0/1]
    ...
    : - PID	Status	Label
    : - -	1	org.thetripps.emacs
    : - -	78	org.thetripps.isync
...
** Client Start-up
   ...
   #+BEGIN_SRC sh
     ...
     EMACS_PATH=`/usr/local/bin/brew --prefix emacs-mac`/bin
     EMACSCLIENT=${EMACS_PATH}/emacsclient

     $EMACSCLIENT -nc -s launchd $TARGET
   #+END_SRC
