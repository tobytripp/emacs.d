...
*** =auth-sources=
    ...
    - To clear the Emacs authentication cache:
      #+BEGIN_SRC emacs-lisp :tangle on :exports code
        (auth-source-forget-all-cached)
      #+END_SRC
    - The current set of sources:
      #+name: current-sources
      #+BEGIN_SRC emacs-lisp :tangle no :exports both :results list
        auth-sources
      #+END_SRC
...
*** Authentication Secret Look-up
    ...
    - =auth-sources= usage
      ...
      #+BEGIN_SRC emacs-lisp :tangle no :results value :exports both
      ...
      #+name: call-example
      #+BEGIN_SRC emacs-lisp :tangle no :results verbatim :exports both
...
** ADOPTED mbsync
   ...
   #+BEGIN_SRC conf :tangle ~/.mbsyncrc :tangle-mode (identity #o640)
     # -*- mode: conf -*-
     Expunge Both
     SyncState *
   #+END_SRC
...
*** GMail
    ...
    #+name: gmail-account
    #+BEGIN_SRC conf :tangle ~/.mbsyncrc :noweb yes :exports none
     IMAPAccount gmail
     Host imap.gmail.com
     Port 993
    ...
    #+BEGIN_SRC conf :tangle no :noweb no :exports code
     IMAPAccount gmail
     Host imap.gmail.com
     Port 993
     User << get-secret(property="gmail-user") >>
    ...
    #+BEGIN_SRC sh :tangle no :results output :exports code
      mkdir -p ~/.mail/gmail
      mbsync -al
    #+END_SRC
...
*** iCloud
    ...
    #+name: iCloud-Account
    #+BEGIN_SRC conf :tangle no :noweb no
      IMAPAccount icloud
      Host imap.mail.me.com
      Port 993
      User <<get-secret(property="icloud-user")>>
