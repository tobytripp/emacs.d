...
;; '(default-frame-alist (quote (quote (quote (quote ((vertical-scroll-bars) (cursor-type . box) (internal-border-width . 0) (left-fringe . 1) (right-fringe) (fringe) (background-color . "#211E1E") (background-mode . dark) (background-toolbar-color . "#cf3ccf3ccf3c") (border-color . "Grey") \.\.\.))))))
 ...
 '(mmm-mode-ext-classes-alist (quote ((web-mode "\\.mm\\'" mason) (html-mode "\\.mm\\'" mason) (ruby-mode "\\.rb\\'" toby/heredoc))))
